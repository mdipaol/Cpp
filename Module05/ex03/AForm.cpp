...
/*   Updated: 2023/09/10 15:41:42 by mdi-paol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(const std::string& name, int gradeReqSign, int gradeReqExec) : _name(name), _isSigned(false), _gradeReqSign(gradeReqSign), _gradeReqExec(gradeReqExec)
{
